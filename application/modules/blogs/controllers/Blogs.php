  ...
  function __construct() {
    ...
    function index() {
        ...
        if($this->input->get('ajax')==1){
          ...
          $data = $this->ajaxPageList($this->Blogs, $columns, $searchableColumns, $options, $imageColumns, []);
          echo $data;exit;
        }
        else{
          $paginationConfig = $this->config->item('pagination');
          $this->data['page_title'] = SITE_TITLE.' :: Blogs list';
          $this->data['page'] = $this->_viewPath . "blogs.php";
