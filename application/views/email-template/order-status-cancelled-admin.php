...
<head>
    ...
    <title><?php echo SITE_TITLE;?> : Order Status Update</title>
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                    <div class="media m-b-30 p-t-20">
                                        <div class="media-body"> 
                                            ...
                                            <p>We would like to inform you that Order < {{order.order_id}} > has been {{order.status}} by Cashvertise. Please contact us immediately if this was not requested by you. Click the link below to view your order. </p></br>
