...
class ImageManipulator
{
    ...
    public function resample($width, $height, $constrainProportions = true)
    {
        ...
        //If image size is less than required view page dimensions then no need to resize on 27th Jun 2017
        if($new_width==408 && $new_height==300)
        {
        	if($width>$height)
        	{
        		if($width<=408 && $height<=300)
        		{
        			$scaled_width = $width;
        			$scaled_height = $height;
        		}
        ...
        $temp = imagecreatetruecolor($scaled_width, $scaled_height);
        imagecopyresampled($temp, $this->image, 0, 0, 0, 0, $scaled_width, $scaled_height, $this->width, $this->height);
     ...
     * @throws RuntimeException
     */
    public function save($fileName, $type = IMAGETYPE_JPEG,$degrees)
    {
