               ...
               <div>
                  <div class="PageProduct-details">
                     ...
                     <div class="PageProduct-u-tabAlignment"></div>
                      <div class="PageProduct-details">
                     <div class="PageProduct-u-tabAlignment">
                        <h2 class="h3">Product Compare</h2>
                        <style type="text/css">
                           ...
                           <?php 
                              if(!empty($compare_list) && count($compare_list) > 0){
                            ?>
                           <table class="tg" bgcolor="grey" border="">
                           <thead>
                             <tr>
                               <th class="tg-0lax">Name of the offer in the store</th>
                               <th class="tg-0lax">Price and shipping costs</th>
                               <th class="tg-0lax">Store and valuation</th>
                               <th class="tg-0lax">Store Logo</th>
                               <th class="tg-0lax">view Offer</th>
                           ...
                           <tbody>
                           <?php 
                              foreach($compare_list as $key => $valueList){
                              if(isset($valueList['store_image']) && $valueList['store_image'] != ''){
                                 $storeImage = base_url().IMAGE_PATH_URL.STORES_FOLDER.$valueList['store_image'];
                              }else{
                                 $storeImage ='';
                              }
                           ...
                           ?>
                             <tr>
                               <td class="tg-0lax"><?php echo $valueList['product_name']; ?></td>
                               <td class="tg-0lax"><?php echo $valueList['price']; ?></td>
                               <td class="tg-0lax"><?php echo $valueList['store_name']; ?></td>
                               <td class="tg-0lax"><?php echo '<img src="'.$storeImage.'?auto=format&fm=pjpg&fit=max&s=a2d55acb2fd5c8b0cfa6ce0725bd07db" />'; ?></td>
                               <td class="tg-0lax"><a href="<?php echo base_url();?>/productdetails/<?php echo $valueList['product_id'];?>"  class="btn btn-primary CProductAddToCart-cartButton t-quickViewAddToCart">View Offer</a></td>
                                 ...
                                 <div class="EmailSellerForm-wrapper">
                                    ...
                                    <div class="EmailSellerForm">
                                          ...
                                          <div class="MField EmailSellerForm-edm">
                                             <label>
                                                <input type="checkbox" class="EmailSellerForm-edm-checkbox" name="edm_enabled" checked="">&nbsp;I would like to receive emails from marketplacephones.com.</label>
                                          </div>
                                          <div class="EmailSellerForm-privacy-policy">
                                             <p>marketplacephones.com takes the privacy of your data seriously. To learn more, read our <a href="/article/privacy-and-security" target="_blank">privacy policy</a>.</p>
                                          </div>
